      ...
      <div className="relative mx-auto max-w-7xl overflow-hidden">
        ...
        <div className="mb-6 flex flex-col items-center text-center">
          <div className="mb-2 flex items-center gap-3">
            ...
            <h1 className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-3xl font-bold leading-tight text-transparent">
              ProZoneSAM2
            </h1>
          </div>
        ...
        <div className="grid gap-4 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            {/* Upload Section */}
            <Card className="border-blue-200 bg-gradient-to-br from-white to-blue-50/50 p-5 dark:border-blue-800 dark:from-slate-900 dark:to-blue-950/20">
              <div className="mb-3 flex items-center gap-2">
                <div className="h-5 w-1 rounded-full bg-gradient-to-b from-blue-500 to-purple-500" />

                <h2 className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-base font-bold text-transparent">
                  上传图像
                </h2>
              </div>
              ...
              <div className="space-y-2.5">
                ...
                <label htmlFor="image-upload">
                  <Button
                    variant="outline"
                    className="h-9 w-full border-blue-300 transition-all hover:border-blue-400 hover:bg-blue-50 dark:border-blue-700 dark:hover:bg-blue-950/30"
                    asChild
                  >
                ...
                {image && (
                  <Button
                    variant="ghost"
                    onClick={resetAll}
                    className="h-9 w-full text-slate-600 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-100"
                  >
            ...
            {/* Box Type Selection */}
            <Card className="border-orange-200 bg-gradient-to-br from-white to-orange-50/50 p-5 dark:border-orange-800 dark:from-slate-900 dark:to-orange-950/20">
              <div className="mb-3 flex items-center gap-2">
                <div className="h-5 w-1 rounded-full bg-gradient-to-b from-blue-500 to-orange-500" />

                <h2 className="bg-gradient-to-r from-blue-600 to-orange-600 bg-clip-text text-base font-bold text-transparent">
                  标注类型
                </h2>
              </div>
              ...
              <div className="space-y-2">
                <label
                  className="flex cursor-pointer items-center space-x-3 rounded-lg border-2 p-2.5 transition-all hover:border-blue-400 hover:bg-blue-50/50 dark:border-blue-900 dark:hover:bg-blue-950/20"
                  style={{
                    borderColor:
                      selectedBoxType === 'WG'
                        ? 'rgba(59, 130, 246, 0.5)'
                ...
                <label
                  className="flex cursor-pointer items-center space-x-3 rounded-lg border-2 p-2.5 transition-all hover:border-orange-400 hover:bg-orange-50/50 dark:border-orange-900 dark:hover:bg-orange-950/20"
                  style={{
                    borderColor:
                      selectedBoxType === 'CG'
                        ? 'rgba(249, 115, 22, 0.5)'
            ...
            {/* Instructions */}
            <Card className="border-purple-200 bg-gradient-to-br from-white to-purple-50/50 p-5 dark:border-purple-800 dark:from-slate-900 dark:to-purple-950/20">
              <div className="mb-3 flex items-center gap-2">
                <div className="h-5 w-1 rounded-full bg-gradient-to-b from-purple-500 to-pink-500" />

                <h2 className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-base font-bold text-transparent">
                  使用指南
                </h2>
              </div>
              ...
              <ul className="space-y-2 text-base text-slate-600 dark:text-slate-400">
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 text-xs font-bold text-white">
                    1
                  </span>
                  <span>上传医学图像</span>
                </li>
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-cyan-500 to-green-500 text-xs font-bold text-white">
                    2
                  </span>
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-green-500 to-yellow-500 text-xs font-bold text-white">
                    3
                  </span>
                  <span>在图像上绘制标注框</span>
                </li>
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-yellow-500 to-orange-500 text-xs font-bold text-white">
                    4
                  </span>
                  <span>运行分割</span>
                </li>
